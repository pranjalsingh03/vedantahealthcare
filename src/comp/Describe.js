    ...
    return (
        <>
            ...
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold mb-4">360 DEGREE PHYSIO CARE</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white rounded-sm shadow-md overflow-hidden">
                        <img className="w-full h-56 object-cover object-center" src={support} alt="Clinic Treatment" />
                        <div className="p-4">
                    ...
                    <div className="bg-white rounded-sm shadow-md overflow-hidden">
                        <img className="w-full h-56 object-cover object-center" src={support} alt="Physio Home Visits" />
                        <div className="p-4">
                    ...
                    <div className="bg-white rounded-sm shadow-md overflow-hidden">
                        <img className="w-full h-56 object-cover object-center" src={support} alt="Digital Care" />
                        <div className="p-4">
